...
class NotificationSystemPage extends StatefulWidget {
  const NotificationSystemPage({super.key});

  @override
  State<NotificationSystemPage> createState() => _NotificationSystemPageState();
}

class _NotificationSystemPageState extends State<NotificationSystemPage>
    ...
    if (!_hasInitialized) {
      ...
      context.read<NotificationBloc>().add(
        GetUserNotificationsEvent(
          page: 0,
          size: 20,
          categoryName: CategoryEnum.system.name,
        ),
      );
    }
  }
