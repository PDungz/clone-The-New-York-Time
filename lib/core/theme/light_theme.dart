...
class LightTheme extends BaseTheme {
  ...
  String get backgroundSplash =>
      $AssetsImagesBackgroundGen().backgroundLoginOne.path;
  // ===== Brand Colors =====
  @override
  ...
  @override
  Color get highlight => AppNYTColors.lightHighlight;
  ...
  @override
  List<Color> get fadeGradient => AppNYTColors.lightFadeGradient;
  ...
  // ===== Interactive Elements - LIGHT THEME SPECIFIC =====
  @override
  Color get buttonPrimary => AppNYTColors.lightButtonPrimary;

  @override
  Color get buttonPrimaryText => AppNYTColors.lightButtonPrimaryText;

  @override
  Color get buttonSecondary => AppNYTColors.lightButtonSecondary;

  @override
  Color get buttonSecondaryText => AppNYTColors.lightButtonSecondaryText;

  @override
  Color get selectionActive => AppNYTColors.lightSelectionActive;

  // ===== Interactive States - LIGHT THEME SPECIFIC =====
  @override
  Color get ripple => AppNYTColors.lightRipple;

  @override
  Color get hover => AppNYTColors.lightHover;

  @override
  Color get focus => AppNYTColors.lightFocus;
