...
import 'package:news_app/core/config/config_env/env_prod.dart';

/// Production configuration for the News App
/// This configuration is used in production environment
class AppProdConfig implements AppConfigBase {
  ...
  // ========== API Configuration ==========
  @override
  String get apiBaseUrl => _dynamicApiBaseUrl ?? EnvProd.baseUrl; // The base URL for the API

  @override
  String get apiBaseUrlNYT => EnvProd.baseUrlNYT; // The base URL for the API

  @override
  String get apiKeyNYTimes => EnvProd.apiKeyNYTimes;

  //! ========== WebSocket Configuration ==========

  @override
  String get wsBaseUrl => _dynamicWebSocketBaseUrl ?? EnvProd.wsBaseUrl;

  @override
  String get wsNotificationNative => EnvProd.wsNotificationNative;

  @override
  String get wsNotificationUnread => EnvProd.wsNotificationUnread;

  //! ========== Auth API Endpoints ==========

  @override
  String get apiAuthLogin => EnvProd.apiAuthLogin;

  @override
  String get apiAuthBiometricLogin => EnvProd.apiAuthBiometricLogin;

  @override
  String get apiAuthRegister => EnvProd.apiAuthRegister;

  @override
  String get apiAuthRefresh => EnvProd.apiAuthRefresh;

  @override
  String get apiAuthLogout => EnvProd.apiAuthLogout;

  @override
  String get apiAuthChangePassword => EnvProd.apiAuthChangePassword;

  //! ========== Device API Endpoints ==========

  @override
  String get apiDeviceCreate => EnvProd.apiDeviceCreate;

  @override
  String get apiDeviceGetById => EnvProd.apiDeviceGetById;

  @override
  String get apiDeviceGetUserById => EnvProd.apiDeviceGetUserById;

  @override
  String get apiDeviceDeleteById => EnvProd.apiDeviceDeleteById;

  @override
  String get apiDeviceManagementCreate => EnvProd.apiDeviceManagementCreate;

  @override
  String get apiDeviceManagementListUser => EnvProd.apiDeviceManagementListUser;

  @override
  String get apiDeviceManagementDelete => EnvProd.apiDeviceManagementDelete;

  @override
  String get apiDeviceManagementUpdateBiometric => EnvProd.apiDeviceManagementUpdateBiometric;

  //! ========== Notification API Endpoints ==========

  @override
  String get apiNotificationsUser => EnvProd.apiNotificationsUser;

  @override
  String get apiNotificationsUserUnread => EnvProd.apiNotificationsUserUnread;

  @override
  String get apiNotificationsUserRead => EnvProd.apiNotificationsUserRead;

  @override
  String get apiNotificationsUserReadAll => EnvProd.apiNotificationsUserReadAll;

  @override
  String get apiNotificationsCountUnread => EnvProd.apiNotificationsCountUnread;

  @override
  String get apiNotificationsCategories => EnvProd.apiNotificationsCategories;

  @override
  String get apiNotificationsHealth => EnvProd.apiNotificationsHealth;

  @override
  String get apiNotificationsTopicSubscribe => EnvProd.apiNotificationsTopicSubscribe;

  @override
  String get apiNotificationsTopicUnsubscribe => EnvProd.apiNotificationsTopicUnsubscribe;

  @override
  String get apiNotificationsValidateToken => EnvProd.apiNotificationsValidateToken;

  //! ========== Dynamic URL Methods ==========

  @override
  String topStoriesUrl({required String section}) => EnvProd.topStoriesUrl(section: section);

  @override
  String apiDeviceManagementInfoIndentifierUserId({
    required String deviceIdentifier,
    required String userId,
  }) => EnvProd.apiDeviceManagementInfoIndentifierUserId(
  ...
  String apiNotificationsUserCategory({required String categoryName}) =>
      EnvProd.apiNotificationsUserCategory(categoryName: categoryName);

  @override
  String apiNotificationsUserStatus({required String status}) =>
      EnvProd.apiNotificationsUserStatus(status: status);

  @override
  String apiNotificationsMarkRead({required String notificationId}) =>
      EnvProd.apiNotificationsMarkRead(notificationId: notificationId);

  @override
  String apiNotificationsCountStatus({required String status}) =>
      EnvProd.apiNotificationsCountStatus(status: status);

  @override
  String apiNotificationsDelete({required String notificationId}) =>
      EnvProd.apiNotificationsDelete(notificationId: notificationId);

  @override
  String? get webSocketBaseUrl => _dynamicWebSocketBaseUrl ?? EnvProd.wsBaseUrl; // The base URL for the WebSocket connection
  ...
  // Android
  @override
  String? get apiKeyAndroid => EnvProd.apiKeyAndroid;
  @override
  String? get appIdAndroid => EnvProd.appIdAndroid;
  @override
  String? get messagingSenderIdAndroid => EnvProd.messagingSenderIdAndroid;

  // Ios
  @override
  String? get apiKeyIOS => EnvProd.apiKeyIOS;
  @override
  String? get appIdIOS => EnvProd.appIdIOS;
  @override
  String? get messagingSenderIdIOS => EnvProd.messagingSenderIdIOS;
